...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  * |LCTRL |   Z  |   X  |   C  |   V  |   B  |-------|              |-------|   /  |   N  |   M  |   ,  |   .  |   \  |
  * `-----------------------------------------/       /              \       \-----------------------------------------'
  *                   | LAlt |BackSP|LOWER | /Enter  /                \Space  \  |RAISE | LGUI | CAPS |
  *                   |      |      |      |/       /                  \       \ |      |      |      |
  *                   `----------------------------'                    '-------''--------------------'
  */
  [QWERTY] = LAYOUT( \
    ...
    KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,      KC_RBRC,   KC_LBRC, KC_SLSH,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_BSLS,   \
                               KC_LALT,          MO(LOWER), KC_SPC,    KC_ENT,  TT(RAISE), KC_LGUI, KC_CAPS                               \
  ),
  ...
  * `-----------------------------------------/       /              \       \-----------------------------------------'
  *                   |      |      |      | /MOUSE 1/                \MOUSE 2\  |QWERTY|   0  |Enter |
  *                   |      |      |      |/       /                  \       \ |      |      |      |
  *                   `----------------------------'                    '-------''--------------------'
  */
  [RAISE] = LAYOUT( \
